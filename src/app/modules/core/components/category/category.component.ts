...
export class CategoryComponent implements OnInit {
  ...
  getCategories():Category[] {
    return [
      new Category(1, 'Documents perso', 'Description documents perso', 'folder.png'),
      new Category(2, 'Images', 'Description images', 'folder.png'),
      new Category(3, 'CV', 'Description CV', 'folder.png'),
      new Category(4, 'Factures', 'Description factures', 'folder.png'),
      new Category(5, 'Contrats', 'Description contrats', 'folder.png'),
      new Category(6, 'Diplomes', 'Description diplomes', 'folder.png'),
      new Category(7, 'Applications', 'Description applications', 'folder.png'),
      new Category(8, 'Autres', 'Description autres', 'folder.png'),
